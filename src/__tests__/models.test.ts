import { ChatMessage, Usage, AssistantRolesEnum } from '../ink/models.js'

import { RenderRow, RenderColumn, Node, TreeHolder, TreeItem } from '../ink/ui-models.js'
...
describe('models', () => {
  ...
  describe('Usage interface', () => {
    it('should create a valid usage object', () => {
      const usage: Usage = {
        ...
        prompt_tokens_details: { cached_tokens: 20, audio_tokens: 0, cache_write_tokens: 0 },
  ...
  describe('AssistantRolesEnum', () => {
    it('should have expected string values', () => {
      ...
      expect(AssistantRolesEnum.system).toBe('system')
    })
  })
})
